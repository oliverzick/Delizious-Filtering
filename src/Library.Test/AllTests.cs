...
namespace Delizious.Filtering
{
    ...
    public sealed class AllTests
    {
        ...
        {
            Assert.IsTrue(NewInstance().Matches(1));
        }

        [TestMethod]
        public void Match_Succeeds_When_All_Matches_Succeed()
        {
            Assert.IsTrue(NewInstance(1, 1, 1).Matches(1));
        }

        [TestMethod]
        public void Match_Fails_When_At_Least_One_Match_Fails()
        {
            Assert.IsFalse(NewInstance(1, 0, 1).Matches(1));
        }

        [TestMethod]
        public void Match_Fails_When_All_Matches_Fail()
        {
            Assert.IsFalse(NewInstance(0, 0, 0).Matches(1));
        }
