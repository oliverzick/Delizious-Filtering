...
namespace Delizious.Filtering
{
    ...
    public static class Match
    {
        ...
        /// <summary>
        /// Creates a <see cref="Match{T}"/> instance that matches successfully when the value to match is greater than or equal to the specified <paramref name="reference"/>.
        /// </summary>
        /// <param name="reference">
        ...
        /// </typeparam>
        /// <returns>
        /// A new <see cref="Match{T}"/> instance that determines whether the value to match is greater than or equal to the specified <paramref name="reference"/>.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="reference"/> is <c>null</c>.
        /// </exception>
        ...
        /// <summary>
        /// Creates a <see cref="Match{T}"/> instance that matches successfully when the value to match is less than or equal to the specified <paramref name="reference"/>.
        /// </summary>
        /// <param name="reference">
        ...
        /// </typeparam>
        /// <returns>
        /// A new <see cref="Match{T}"/> instance that determines whether the value to match is less than or equal to the specified <paramref name="reference"/>.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="reference"/> is <c>null</c>.
        /// </exception>
        ...
        /// </typeparam>
        /// <returns>
        /// A new <see cref="Match{T}"/> instance that determines whether a value matches any of the specified <paramref name="matches"/>.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// <paramref name="matches"/> is <c>null</c>.
        /// </exception>
